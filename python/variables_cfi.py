...
variableList = [
    ...
    cms.PSet(
      variable    = cms.string("HLT_HT_4p5_pt"),
      store       = cms.bool(False),
      mconly      = cms.bool(False),
      description = cms.string("HLT_HT_4p5_pt"),
      requires    = cms.vstring(),
      runOptions  = cms.vstring("runEventInfo"),
    ),
    cms.PSet(
      variable    = cms.string("HLT_HT_4p5_phi"),
      store       = cms.bool(False),
      mconly      = cms.bool(False),
      description = cms.string("HLT_HT_4p5_phi"),
      requires    = cms.vstring(),
      runOptions  = cms.vstring("runEventInfo"),
    ),
    cms.PSet(
      variable    = cms.string("HLT_HT_4p5_sumEt"),
      store       = cms.bool(False),
      mconly      = cms.bool(False),
      description = cms.string("HLT_HT_4p5_sumEt"),
      requires    = cms.vstring(),
      runOptions  = cms.vstring("runEventInfo"),
    ),
    cms.PSet(
