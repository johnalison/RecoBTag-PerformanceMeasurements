...
process.L1PlusQCDMuon_PFHT330PT30_QuadPFPuppiJet_75_60_45_40_TriplePFPuppiBTagDeepCSV_2p4_v1 = cms.Path(
    process.muGenFilter
    +process.l1tPFPuppiHTMaxEta2p4
    +process.l1tPFPuppiHT400offMaxEta2p4
    +process.l1t1PFPuppiJet70offMaxEta2p4
...
process.L1PlusQCDMuon_DoublePFPuppiJets128MaxDeta1p6_DoublePFPuppiBTagDeepCSV_p71_2p4_v1 = cms.Path(
    process.muGenFilter
    +process.l1tDoublePFPuppiJet112offMaxEta2p4
)
...
process.schedule_().extend([
  ...
  process.L1PlusQCDMuon_PFHT330PT30_QuadPFPuppiJet_75_60_45_40_TriplePFPuppiBTagDeepCSV_2p4_v1,
  process.L1_DoublePFPuppiJets128MaxDeta1p6_DoublePFPuppiBTagDeepCSV_p71_2p4_v1,
  process.L1PlusQCDMuon_DoublePFPuppiJets128MaxDeta1p6_DoublePFPuppiBTagDeepCSV_p71_2p4_v1,
