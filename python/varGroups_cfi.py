  ...
  groups = cms.VPSet(
    ...
    cms.PSet(
      ...
      variables   = cms.vstring(
        ...
        "pileupInfo_BX0_numTrueInteractions",
        "pileupInfo_BX0_max_pT_hats",
        "pileupInfo_BX0_n_pThat000to020",
        "pileupInfo_BX0_n_pThat020to030",
        "pileupInfo_BX0_n_pThat030to050",
        "pileupInfo_BX0_n_pThat050to080",
        "pileupInfo_BX0_n_pThat080to120",
        "pileupInfo_BX0_n_pThat120to170",
        "pileupInfo_BX0_n_pThat170to300",
        "pileupInfo_BX0_n_pThat300to470",
        "pileupInfo_BX0_n_pThat470to600",
        "pileupInfo_BX0_n_pThat600toInf",
        "nPUtrue",
        "nPU",
      ),
    ),
...
cms.PSet(
  group       = cms.string("JetTruthInfo"),
  store       = cms.bool(False),
  description = cms.string("Jet truth matched info"),
  variables   = cms.vstring(
    "PuppiJet.Jet_isB",
